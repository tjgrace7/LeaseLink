...
-property_taxes (A summary of who is responsibility for property taxes and how those are charged) 
...
-rent_commencement_date (Date that rent starts often the same date as lease commencement date, but not always, yyyy/mm/dd force into format)
